    ...
    public void tick(MinecraftServer server, int ticks) {
        ...
        for (ServerPlayerEntity p : server.getPlayerManager().getPlayerList()) {
            ...
            for (Entity e : w.getOtherEntities(p, new Box(p.getBlockPos()).expand(CROWD_R + 64, 128, CROWD_R + 64), e -> AotRpg.isTitan(e))) {
                ...
                if (TitanGuard.isShifter(e) || HomeRaids.raider(e) || FactionWar.eventTitan(e) || Raids.raidMob(e) || TitanActivity.managed(e) || e.hasPassengers() || e.getControllingPassenger() instanceof PlayerEntity) continue;
                near.add(e);
            }
